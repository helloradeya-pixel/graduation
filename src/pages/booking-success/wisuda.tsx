...
export default function BookingSuccessWisuda() {
  useEffect(() => {
    if (typeof window === 'undefined') return;
    const params = new URLSearchParams(window.location.search);

    const service = 'graduation';
    ...
    let message = `Halo kak, saya sudah booking wisuda atas nama ${nama}.\n\n*Detail Booking:*\nPackage: ${paket}\nTanggal: ${tanggal}\nJam: ${jamMulai} - ${jamSelesai}\nDP: Rp${value.toLocaleString('id-ID')}`;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-white">
      <Head>
        <title>Booking Wisuda Berhasil | Radeya Photography</title>
      </Head>
      <div className="text-center">
        <h1 className="text-2xl font-bold">Booking Wisuda Berhasil</h1>
